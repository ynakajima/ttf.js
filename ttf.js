...
(function() {
  var CompositeGlyph, GlyfTable, HeadTable, LocaTable, MaxpTable, SimpleGlyph, TTFDataView, TrueType, ttfjs;

  TTFDataView = (function() {

    function TTFDataView(jDataView) {
      this.view = jDataView;
    }
  ...
  TrueType = (function() {
    ...
    TrueType.createFromTTFDataView = function(view) {
      var checkSum, i, length, offset, sfntVersionNumber, sfntVersionString, tableOffsets, tag, ttf;
      ttf = new TrueType();
